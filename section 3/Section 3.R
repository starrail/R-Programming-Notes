...
#a single number or a single character is a vetor with lengthe 1
...
is.numeric(V4) #FALSE
##a vector with elements in the same type
...
#[50,32,111,7,24] + [100,2,56,12,0,65,93,10,244,1] -> past and copy the shorter vector at the end of the vector
  #[50,32,111,7,24,50,32,111,7] + [100,2,56,12,0,65,93,10,244,1]
##vector and function
...
#vectorized approach run more quickly than devectorized approach does
...
seq(from=10,to=20,along.with=x) 
  #along.with-specify a vector that want the vector generating to have the same length off
  #take the length from the length of this argument.

rep(5:6,times=10)
rep(5:6,each=10) #each variable replicated 10 times
